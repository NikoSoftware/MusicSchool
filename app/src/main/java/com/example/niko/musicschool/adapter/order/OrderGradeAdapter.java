...
import com.example.niko.musicschool.activity.exam.MusicGradeDetail;
...
public class OrderGradeAdapter extends BaseRecyclerViewAdapter<OrderGradeParamModel> {
    ...
    @Override
    public void onBind(BaseViewHandle holder, int position, final OrderGradeParamModel model, int viewType) {
        ...
        ((TextView) holder.getView(R.id.tv_check_detail)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundel.putSerializable("OrderGradeParamModel",model);
                ((BaseActivity) context).skip(context, MusicGradeDetail.class,bundel);
